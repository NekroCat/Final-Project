...
function BasicResultPage() {
    ...
    const generateCareerRecommendations = async () => {
        try {
            ...
            if (Object.keys(answers).length === 0) {
                setError("No quiz answers found. Please complete the Basic Quiz first.");
                setIsLoading(false);
                return;
            }
    ...
    const createPrompt = (answers: { [key: string]: string }) => {
        return `Based on the following basic career quiz answers, suggest the top 3 career paths that would be a good fit, with a brief description for each and a match percentage. For each career, explain why it matches their preferences based on their answers.
    ...
    const handleTryAnotherQuiz = () => {
        // clear only the basic quiz answers
    ...
    const handleSaveResults = () => {
        ...
        try {
            ...
            pdf.text("(Basic Quiz)", 105, 30, { align: "center" });
            pdf.setFontSize(12);
            ...
            const conclusionText = [
                "These recommendations are based on your basic quiz responses. For more personalized",
                "recommendations, consider taking our Detailed Quiz.",
                "",
                "You can also research these career paths further, talk to professionals in these fields,",
                "or explore educational requirements.",
                "",
                "Remember that career choices are personal decisions that can evolve over time. These",
                "suggestions are meant as a starting point for your career exploration journey."
            ];
            ...
            pdf.save("pathfinder-basic-results.pdf");
        } catch (error) {
    ...
    const handleTryDetailedQuiz = () => {
        navigate('/detailed-questions');
    };
                    ...
                    <>
                        <div style={{ marginBottom: '2rem', textAlign: 'center' }}>
                            <p style={{ fontSize: '1.1rem' }}>
                                Based on your Basic Quiz responses, 
                        ...
                        <div style={{ marginTop: '3rem', padding: '1.5rem', backgroundColor: theme.headerFooter, borderRadius: '10px' }}>
                            ...
                            <p>These recommendations are based on your basic quiz responses. For more personalized recommendations, consider taking our Detailed Quiz.</p>
                            <p>You can also research these career paths further, talk to professionals in these fields, or explore educational requirements.</p>
